...
| P1 — Keycloak Admin helper | [MINI_SAAS_P1_EXECUTION.md](./MINI_SAAS_P1_EXECUTION.md) | first-push | done |
...
| `saas-base-v3` | annotated tag on `main` after merge | SHA: `b164675397482b8b351db08f8f050e0d3e6248ba` |