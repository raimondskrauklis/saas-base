...
| VSORG | GitHub organisation `VIRAC-SPACE`, [github.com/VIRAC-SPACE](https://github.com/VIRAC-SPACE), repository metadata via GitHub API, observed 2026-09-22 | Public repositories, languages, last-push dates — see `software.md` |
| ISBIP | VIRAC-SPACE, ISBI_pipeline (`irib.py`), [github.com/VIRAC-SPACE/ISBI_pipeline](https://github.com/VIRAC-SPACE/ISBI_pipeline) | Full IVARS reduction step list in ParselTongue/AIPS; author R. A. Burns; funded lzp-2022/1-0083 |
...
| ACC | LUMI training materials — "Accessing LUMI and transferring data", "LUMI-O object storage" and "Advanced usage of LUMI-O" (LUMI 2-day course, April 2026; [lumi-supercomputer.github.io](https://lumi-supercomputer.github.io/LUMI-training-materials/)) | Storage lifetime and no-backup policy; `sftp` single-stream limits; LUMI-O as transfer path; `lumio-conf`, path-style S3, ACL/public-object model; stale multipart uploads; LUMI-O ↔ Lustre bandwidth; no Globus |
